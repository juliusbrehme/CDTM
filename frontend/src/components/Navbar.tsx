  ...
  return (
    <nav className="bg-white border-b border-gray-200 py-4 px-6 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center space-x-6">
        <Link to="/" className="text-gray-600 hover:text-traderepublic-purple transition-colors">
          Home
        </Link>
        <Link to="/" className="text-gray-600 hover:text-traderepublic-purple transition-colors">
          Invest
      ...
      <div className="flex items-center space-x-4">
        <Button variant="outline" className="border-traderepublic-purple text-traderepublic-purple hover:bg-traderepublic-purple hover:text-white">
          Log In
        </Button>
